...
export const defaultSettings = {
  ...
  autoCrateBreak_: {
    enabled_: true,
    autoSwitchMelee_: false,
    autoAttack_: true,
    detectionRadius_: 10,
  },
  panHero_: {
    enabled_: false,
    targetKnocked_: false,
  },
  layerSpoof_: {
    enabled_: true,
  },
  ...
  keybinds_: {
    ...
    toggleAimbot_: 'KeyB',
    toggleAutoFire_: 'Not Set',
    toggleAutoHeal_: 'Not Set',
    toggleESP_: 'Not Set',
    toggleXRay_: 'Not Set',
    toggleStickyTarget_: 'KeyN',
    togglePanHero_: 'Not Set',
    toggleInfiniteZoom_: 'ShiftLeft',
    toggleLayerSpoof_: 'KeyT',
    toggleAutoLoot_: 'Not Set',
    toggleAutoCrate_: 'Not Set',
