...
const handleKeyDown = (event) => {
  if (settings.infiniteZoom_.enabled_ && event.code === settings.keybinds_.toggleInfiniteZoom_ && settings.keybinds_.toggleInfiniteZoom_ !== 'Not Set') {
...
const handleWheelEvent = (event) => {
  if (!isZoomKeyPressed || !settings.infiniteZoom_.enabled_) return;
